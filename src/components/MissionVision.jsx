      ...
      <div className="container">
        <div className="mission">
          <div className="text">
            ...
            <p>
              ...
              that energize the body and lift the spirit, served with care and
              passion.
            </p>
          </div>
        ...
        <div className="vision">
          ...
          <div className="text">
            <h2>Our Vision</h2>
            <p>
              To be the go-to destination for vibrant, healthful, and innovative
              drinks, where people come together to enjoy life, flavor, and
              community.
            </p>
          </div>
        </div>
